...
import { Typography, TextField, FormGroup, FormControlLabel, Checkbox, Grid } from '@mui/material'
...
const ShippingAddress = () => {
    ...
    return (
        <>
            <Typography variant='h6' align='center' sx={{ mt: 5, fontWeight: 600 }}>Shipping Address</Typography>
